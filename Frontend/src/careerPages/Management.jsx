...
import "./career.css";
import management from "../../../College&Exam/management";
import managementRanking from "../../../College&Exam/managementRanking";
...
const Management = () => {
  ...
  const rankings = React.useMemo(
    () => managementRanking.slice().sort((a, b) => a.rank - b.rank),
    []
  );
  ...
  const stateOptions = React.useMemo(() => {
    return [
      "All",
      ...Array.from(new Set(managementRanking.map((c) => c.state))).sort(),
    ];
  }, []);
  ...
  const heroStats = [
    { label: "Total management colleges", value: management.length },
    { label: "Ranked colleges in this list", value: managementRanking.length },
    ...
    <div className="container m-auto pt-5">
      <section className="hero">
        <div className="hero__text">
          ...
          <h1>Find great management colleges in India</h1>
          <p className="lede">
            Simple, student-first view of top management colleges, their cities,
            and what matters before you pick a branch. Built for class 10
      ...
      <section className="panel">
        <header className="panel__header">
          <div>
            ...
            <h2>Explore ranked management colleges</h2>
            <p className="muted">
      ...
      <section className="panel panel--alt">
        <header className="panel__header">
          <div>
            ...
            <p className="muted">
              Top states by total management colleges (sample names included).
            </p>
          </div>
        </header>
