...
import "./career.css";
import pharmacy from "../../../College&Exam/pharmacy";
import pharmacyRanking from "../../../College&Exam/pharmacyRanking";
...
const Pharmacy = () => {
  ...
  const rankings = React.useMemo(
    () => pharmacyRanking.slice().sort((a, b) => a.rank - b.rank),
    []
  );
  ...
  const stateOptions = React.useMemo(() => {
    return [
      "All",
      ...Array.from(new Set(pharmacyRanking.map((c) => c.state))).sort(),
    ];
  }, []);
  ...
  const heroStats = [
    { label: "Total pharmacy colleges", value: pharmacy.length },
    {
      label: "Ranked colleges in this list",
      value: pharmacyRanking.length,
    },
    ...
    <div className="container m-auto pt-5">
      <section className="hero">
        <div className="hero__text">
          ...
          <h1>Find great pharmacy colleges in India</h1>
          <p className="lede">
            Simple, student-first view of top pharmacy colleges, their cities,
      ...
      <section className="panel">
        <header className="panel__header">
          <div>
            ...
            <h2>Explore ranked pharmacy colleges</h2>
            <p className="muted">
      ...
      <section className="panel panel--alt">
        <header className="panel__header">
          <div>
            ...
            <p className="muted">
              Top states by total pharmacy colleges (sample names included).
            </p>
          </div>
        </header>
