...
const Engineering = () => {
  ...
  const rankings = React.useMemo(
    () => engineeringRanking.slice().sort((a, b) => a.rank - b.rank),
    []
  );
  ...
  const stateOptions = React.useMemo(() => {
    return [
      "All",
      ...Array.from(new Set(engineeringRanking.map((c) => c.state))).sort(),
    ];
  }, []);
  ...
  const heroStats = [
    { label: "Total engineering colleges", value: engineering.length },
    { label: "Ranked colleges in this list", value: engineeringRanking.length },
    ...
    <div className="container m-auto pt-5">
      <section className="hero">
        <div className="hero__text">
          ...
          <h1>Find great engineering colleges in India</h1>
          <p className="lede">
            Simple, student-first view of top engineering colleges, their
      ...
      <section className="panel">
        <header className="panel__header">
          <div>
            ...
            <h2>Explore ranked engineering colleges</h2>
            <p className="muted">
      ...
      <section className="panel panel--alt">
        <header className="panel__header">
          <div>
            ...
            <p className="muted">
              Top states by total engineering colleges (sample names included).
            </p>
          </div>
        </header>
