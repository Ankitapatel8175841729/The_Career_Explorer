...
import "./career.css";
import research from "../../../College&Exam/research";
import researchRanking from "../../../College&Exam/researchRanking";
...
const Research = () => {
  ...
  const rankings = React.useMemo(
    () => researchRanking.slice().sort((a, b) => a.rank - b.rank),
    []
  );
  ...
  const stateOptions = React.useMemo(() => {
    return [
      "All",
      ...Array.from(new Set(researchRanking.map((c) => c.state))).sort(),
    ];
  }, []);
  ...
  const heroStats = [
    { label: "Total research colleges", value: research.length },
    {
      label: "Ranked colleges in this list",
      value: researchRanking.length,
    },
    ...
    <div className="container m-auto pt-5">
      <section className="hero">
        <div className="hero__text">
          ...
          <h1>Find great research colleges in India</h1>
          <p className="lede">
            Simple, student-first view of top research colleges, their cities,
      ...
      <section className="panel">
        <header className="panel__header">
          <div>
            ...
            <h2>Explore ranked research colleges</h2>
            <p className="muted">
      ...
      <section className="panel panel--alt">
        <header className="panel__header">
          <div>
            ...
            <p className="muted">
              Top states by total research colleges (sample names included).
            </p>
          </div>
        </header>
