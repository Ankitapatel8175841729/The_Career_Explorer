...
import "./career.css";
import law from "../../../College&Exam/law";
import lawRanking from "../../../College&Exam/lawRanking";
...
const Law = () => {
  ...
  const rankings = React.useMemo(
    () => lawRanking.slice().sort((a, b) => a.rank - b.rank),
    []
  );
  ...
  const stateOptions = React.useMemo(() => {
    return [
      "All",
      ...Array.from(new Set(lawRanking.map((c) => c.state))).sort(),
    ];
  }, []);
  ...
  const heroStats = [
    { label: "Total law colleges", value: law.length },
    { label: "Ranked colleges in this list", value: lawRanking.length },
    ...
    <div className="container m-auto pt-5">
      <section className="hero">
        <div className="hero__text">
          ...
          <h1>Find great law colleges in India</h1>
          <p className="lede">
            Simple, student-first view of top law colleges, their cities, and
      ...
      <section className="panel">
        <header className="panel__header">
          <div>
            ...
            <h2>Explore ranked law colleges</h2>
            <p className="muted">
      ...
      <section className="panel panel--alt">
        <header className="panel__header">
          <div>
            ...
            <p className="muted">
              Top states by total law colleges (sample names included).
            </p>
          </div>
        </header>
