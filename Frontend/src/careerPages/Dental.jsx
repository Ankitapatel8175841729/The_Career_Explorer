...
import "./career.css";
import dental from "../../../College&Exam/dental";
import dentalRanking from "../../../College&Exam/dentalRanking";
...
const Dental = () => {
  ...
  const rankings = React.useMemo(
    () => dentalRanking.slice().sort((a, b) => a.rank - b.rank),
    []
  );
  ...
  const stateOptions = React.useMemo(() => {
    return [
      "All",
      ...Array.from(new Set(dentalRanking.map((c) => c.state))).sort(),
    ];
  }, []);
  ...
  const heroStats = [
    { label: "Total dental colleges", value: dental.length },
    { label: "Ranked colleges in this list", value: dentalRanking.length },
    ...
    <div className="container m-auto pt-5">
      <section className="hero">
        <div className="hero__text">
          ...
          <h1>Find great dental colleges in India</h1>
          <p className="lede">
            Simple, student-first view of top dental colleges, their cities, and
            what matters before you pick a branch. Built for class 10 students
            and parents.
          </p>
      ...
      <section className="panel">
        <header className="panel__header">
          <div>
            ...
            <h2>Explore ranked dental colleges</h2>
            <p className="muted">
      ...
      <section className="panel panel--alt">
        <header className="panel__header">
          <div>
            ...
            <p className="muted">
              Top states by total dental colleges (sample names included).
            </p>
          </div>
        </header>
