...
import "./career.css";
import medical from "../../../College&Exam/medical";
import medicalRanking from "../../../College&Exam/medicalRanking";
...
const Medical = () => {
  ...
  const rankings = React.useMemo(
    () => medicalRanking.slice().sort((a, b) => a.rank - b.rank),
    []
  );
  ...
  const stateOptions = React.useMemo(() => {
    return [
      "All",
      ...Array.from(new Set(medicalRanking.map((c) => c.state))).sort(),
    ];
  }, []);
  ...
  const heroStats = [
    { label: "Total medical colleges", value: medical.length },
    {
      label: "Ranked colleges in this list",
      value: medicalRanking.length,
    },
    ...
    <div className="container m-auto pt-5">
      <section className="hero">
        <div className="hero__text">
          ...
          <h1>Find great medical colleges in India</h1>
          <p className="lede">
            Simple, student-first view of top medical colleges, their cities,
      ...
      <section className="panel">
        <header className="panel__header">
          <div>
            ...
            <h2>Explore ranked medical colleges</h2>
            <p className="muted">
      ...
      <section className="panel panel--alt">
        <header className="panel__header">
          <div>
            ...
            <p className="muted">
              Top states by total medical colleges (sample names included).
            </p>
          </div>
        </header>
